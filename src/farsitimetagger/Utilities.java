...
public class Utilities {
    ...
    public static void Initialize() throws IOException
    {
        ...
        SetMonthMaps(map_MonthValue,map_MonthCalendar,RulesDirectoryPath+"months.txt");
    ...
    private static void SetMonthMaps(HashMap<String, Integer> MonthValue, HashMap<String, String> MonthCalendar, String filePath) throws IOException {
        MonthValue = new  HashMap<String, Integer>();
        MonthCalendar = new HashMap<String, String>();
        try(BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream(new File(filePath)), "UTF8")))
            {    
                ...
                while ((line=in.readLine())!= null)
                {
                    ...
                    MonthValue.put(parts[0], Integer.valueOf(parts[1]));
                    MonthCalendar.put(parts[0], parts[2]);
                }
            }
    }
